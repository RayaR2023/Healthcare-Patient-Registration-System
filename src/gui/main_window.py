...
class MainWindow(ctk.CTk):
    ...
    def display_patient(self, patient):
        self.patient_labels["Patient ID"].configure(text = patient.patient_id)
        self.patient_labels["First Name"].configure(text=patient.first_name)
        self.patient_labels["Last Name"].configure(text=patient.last_name)
        self.patient_labels["Date of Birth"].configure(text=patient.date_of_birth)
        self.patient_labels["Sex"].configure(text=patient.sex)
        self.patient_labels["Phone"].configure(text=patient.phone)
        self.patient_labels["Email"].configure(text=patient.email)
        self.patient_labels["Address"].configure(text=patient.address)
